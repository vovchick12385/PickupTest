...
public:
	...
	TSubclassOf<class APickUpTestProjectile> ProjectileClass;
...
public:
	...
	class UEquippedCardComponent* Equipment;
protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Character | LineOfSight")
